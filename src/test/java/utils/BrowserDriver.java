...
public class BrowserDriver {
    ...
    public static AndroidDriver getBrowserDriver()  {
        ...
        if (browserDriver == null) {
            ...
            // caps.setCapability("chromedriverExecutable","C:\\Users\\Gamzenur\\IdeaProjects\\Team130_AppiumCucumber\\Driver\\chromedriver.exe");
            /*
                eğer ki BrowserName = chrome capability cihazinizda chromeu basarili bir sekilde baslatmiyorsa
                manuel olarak chromedriver sitesinden telefondaki chrome uygulamasinin versiyonuna bakarak
                uygun driver indirilir ardindan bu sekilde capabilty olarak dosya yolu tanitilir
            */
